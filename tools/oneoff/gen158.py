# -*- coding: utf-8 -*-
"""Перенос названий боевых искусств в названия книг-трактатов.

С Name_144 список книг в SkillBook_language.txt повторяет CombatSkill_language.txt.
Строим соответствие «английская строка -> русская» по уже переведённому файлу
искусств и применяем к тем книгам, чьё английское название совпадает.
"""
...
io.open('b158.json', 'w', encoding='utf-8').write(
